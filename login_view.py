...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, master, on_login_success, **kwargs):
        ...
        self.logo_label = ctk.CTkLabel(self.logo_frame, text="RD", font=("Segoe UI", 32, "bold"), text_color=COLOR_WHITE)
        ...
        self.subtitle_label = ctk.CTkLabel(self.card, text="Sistema de Detección de Inconsistencias", font=FONT_SUBTITLE, text_color=COLOR_TEXT_MUTED)
        ...
        self.email_entry = ctk.CTkEntry(self.card, placeholder_text="Ingrese su correo electrónico", 
                                        width=320, height=40, fg_color=COLOR_WHITE, border_color="#CCCCCC", 
        ...
        self.password_entry = ctk.CTkEntry(self.card, placeholder_text="Ingrese su contraseña", 
                                          show="*", width=320, height=40, fg_color=COLOR_WHITE, 
                                          border_color="#CCCCCC", text_color=COLOR_TEXT_DARK)
        self.password_entry.pack(pady=(5, 30))

        # Login Button
        self.login_button = ctk.CTkButton(self.card, text="Iniciar sesión", font=FONT_BUTTON, 
                                         fg_color=COLOR_PRIMARY, hover_color="#0069D9", 
                                         width=320, height=45, corner_radius=5,
