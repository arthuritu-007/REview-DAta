...
class MainApp(ctk.CTkFrame):
    ...
    def __init__(self, master, on_logout, view_factory: IViewFactory, **kwargs):
        ...
        ctk.CTkLabel(rd_logo, text="RD", font=(FONT_FAMILY, 16, "bold"), text_color=COLOR_WHITE).place(relx=0.5, rely=0.5, anchor="center")
        ...
        for text, key, icon in nav_items:
            btn = ctk.CTkButton(self.sidebar, text=f"  {icon}  {text}", font=FONT_SIDEBAR, 
        ...
        # Bottom section
        ctk.CTkFrame(self.sidebar, height=1, fg_color=COLOR_SIDEBAR_HOVER).pack(side="bottom", fill="x", pady=(0, 80))
        
        self.logout_btn = ctk.CTkButton(self.sidebar, text="  🚪  Cerrar Sesión", font=FONT_SIDEBAR, 
    ...
    def switch_tab(self, key):
        if key == self.active_tab_key: return
